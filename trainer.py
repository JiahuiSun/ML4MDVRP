...
class StateCritic(nn.Module):
    ...
    def forward(self, static, dynamic):
        # embedding static and dynamic state and mapping to a value
        # Use the probabilities of visiting each
        # TODO: MTC的方式去估计value，这在节点多的时候不可行吧
        ...
        output = self.fc3(output).sum(dim=2)  # 256x1
        return output
